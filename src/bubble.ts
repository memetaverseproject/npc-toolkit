...
import { Animator, AudioSource, AvatarShape, Billboard, BillboardMode, engine, Entity, Font, GltfContainer, InputAction,Material,MeshCollider,MeshRenderer,pointerEventsSystem,TextAlignMode,TextShape,Transform, TransformType, VisibilityComponent } from '@mtvproject/sdk/ecs'
import * as utils from '@mtvproject/sdk-utils'
import { Dialog, ImageSection } from './types'
import { Color3,Color4, Quaternion, Vector3 } from '@mtvproject/sdk/math'
...
export let bubblesTexture = 'https://memetaverse.club/img/ui/dialog-bubbles.png'
