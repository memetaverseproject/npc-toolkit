...
import { Entity } from '@mtvproject/sdk/ecs'
import {
  buttonClick,
  confirmText,
  displayButton,
...
export let lightTheme = 'https://memetaverse.club/img/ui/light-atlas-v3.png'
export let darkTheme = 'https://memetaverse.club/img/ui/dark-atlas-v3.png'
