...
import { Color3, Quaternion, Vector3 } from '@mtvproject/sdk/math'
        ...
        !data || !data.model || !modelAvatarData
          ? {
            ...
            wearables: [
              ...
              'urn:memetaverse:off-chain:base-avatars:m_lbody_01',
              'urn:memetaverse:off-chain:base-avatars:m_ubody_01',
              'urn:memetaverse:off-chain:base-avatars:m_feed_01',
              'urn:memetaverse:off-chain:base-avatars:m_hair_01',
            ]
          }
          : modelAvatarData
      )
